(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-cliplink dired-collapse dired-quick-sort dired-subtree dired-filter dired+ f exec-path-from-shell spacemacs-theme all-the-icons ivy-rich pcmpl-git git-link git-timemachine magit use-package))))
